...
export default function Home() {
  ...
  const services = [
    { title: "Commercial Interiors", desc: "Innovative designs that reflect your brand's identity and boost productivity.", img: "/comm2.avif" },
    { title: "Residential Interiors", desc: "Creating personalized, luxurious spaces that reflect your unique lifestyle.", img: "/residential.avif" },
    { title: "Civil Constructions", desc: "High-quality construction with a focus on precision, durability, and innovation.", img: "/service.avif" },
    { title: "Architectural Solutions", desc: "Premium, functional, and aesthetically striking designs for timeless environments.", img: "/geze.jpeg" },
  ];

  const projects = [
    { title: "Ritz-Carlton Penthouse", location: "Wellington, NZ", img: "/project1.jpg" },
    { title: "Modernist Villa", location: "Queenstown, NZ", img: "/project2.jpg" },
  ...
  const processSteps = [
    ...
    { number: "03", title: "Construction & Execution", description: "With meticulous project management, we execute the design with precision, ensuring quality at every stage." },
  ...
  const logos = [
    "/logo1.png", "/logo2.png", "/logo3.jpg", "/logo4.png",
    "/logo5.png", "/logo6.webp", "/logo7.svg", "/logo8.png",
    "/logo9.png","/logo10.png",
  ];
  ...
  return (
    <div className="bg-[#111111] text-white">
      <main>
        ...
        >
          <motion.div style={{ opacity, position }} className="inset-0 h-screen w-full">
            <motion.div style={{ scale }} className="h-full w-full relative">
              <Image src="/hero.avif" alt="Modern architecture background" fill priority className="object-cover" />
          ...
          <div className="relative z-10 flex flex-col items-center space-y-6 px-6">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="text-lg md:text-xl max-w-2xl text-gray-300">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1 }} className="absolute bottom-10 left-1/2 -translate-x-1/2 text-white/50">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
                ...
                <div className="mt-12 pt-8 border-t border-gray-700 grid grid-cols-3 gap-8 text-center">
                  ...
                  <div><p className="text-4xl font-bold"><AnimatedCounter value={50} />+</p><p className="text-gray-400 mt-1">Awards</p></div>
                </div>
              </motion.div>
              <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }} className="h-[600px] w-full relative rounded-lg overflow-hidden">
                <Image src="/home2.avif" alt="Elegant interior design" fill className="object-cover" />
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#1a1a1a] py-32">
          <div className="container mx-auto px-4 max-w-7xl">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.8 }} className="text-center mb-16">
              <p className="text-sm font-semibold text-gray-400 uppercase tracking-widest mb-4">What We Do</p>
              <h2 className="text-3xl md:text-4xl font-serif font-bold">Our Services</h2>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {services.map((service, index) => (
                <motion.div key={service.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.7, delay: index * 0.1 }} className="group relative overflow-hidden rounded-lg">
                  <div className="h-96 w-full relative"><Image src={service.img} alt={service.title} fill className="object-cover transition-transform duration-500 group-hover:scale-110" /></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
                  <div className="absolute bottom-0 left-0 p-6">
                    <h3 className="text-xl font-bold mb-2">{service.title}</h3>
                    <p className="text-gray-300 opacity-0 max-h-0 group-hover:opacity-100 group-hover:max-h-40 transition-all duration-500">{service.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <section className="bg-[#1a1a1a] py-32">
            <div className="container mx-auto px-4 max-w-7xl">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.5 }} transition={{ duration: 0.8 }} className="text-center mb-20">
                    ...
                    <h2 className="text-3xl md:text-4xl font-serif font-bold">Our Design & Build Process</h2>
                </motion.div>
        ...
        <section className="bg-[#111111] py-24 overflow-hidden border-t border-b border-gray-800">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-serif font-bold text-gray-400">Trusted by Industry Leaders</h2>
          </div>
