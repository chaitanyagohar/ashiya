...
// Reusable icon components for contact details
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-start">
              ...
              >
                ...
                <InfoCard
                  ...
                  title="Our Office"
                >
                  <p>No 2, Opp to Muniswara Temple, Banjara Layout, Hormavu Agara Main Road, Kalkere Bengaluru -560043</p>
                </InfoCard>
                <InfoCard
                  ...
                  title="Email Us"
                >
                  <a href="mailto:accounts@ashiya.com" className="hover:text-[#c82a2b] transition-colors">accounts@ashiya.com</a>
                </InfoCard>
                <InfoCard
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded bg-[#c82a2b] text-white font-semibold transition-transform duration-300 hover:scale-105"
                >
                  Send Message
                </button>
              </motion.form>
